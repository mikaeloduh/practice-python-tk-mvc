...
class Gear:
    ...
    def toCalculate(self):
        result = {}
        result['grindTime_1'] = 0
        result['dressTime_1'] = 0
        result['grindTime_2'] = 0
        result['dressTime_2'] = 0
        result['grindTime_3'] = 0
        result['dressTime_3'] = 0
        result['grindTime_4'] = 0
        result['dressTime_4'] = 0
        result['cycleTime'] = 0
        ...
        if passes_1:
            result['grindTime_1'] = 6.0 + starts * passes_1 * threadLen / feedForw_1 * (41*200/1.68)
        if byPass_1:
            result['dressTime_1']  = ( 12 + 19*6 * dressPass_1 / dressFeed_1 + 12 ) * (starts * passes_1 // byPass_1)

        if passes_2:
            result['grindTime_2'] = 6.0 + starts * passes_2 * threadLen / feedForw_2 * (41*200/1.68)
        if byPass_2:
            result['dressTime_2']  = ( 12 + 19*6 * dressPass_2 / dressFeed_2 + 12 ) * (starts * passes_2 // byPass_2)

        if passes_3:
            result['grindTime_3'] = 6.0 + starts * passes_3 * threadLen / feedForw_3 * (41*200/1.68)
        if byPass_4:
            result['dressTime_3']  = ( 12 + 19*6 * dressPass_3 / dressFeed_3 + 12 ) * (starts * passes_3 // byPass_3)

        if passes_4:
            result['grindTime_4'] = 6.0 + starts * passes_4 * threadLen / feedForw_4 * (41*200/1.68)
        if byPass_4:
            result['dressTime_4']  = ( 12 + 19*6 * dressPass_4 / dressFeed_4 + 12 ) * (starts * passes_4 // byPass_4)

        result['cycleTime'] = result['dressTime_1'] + result['grindTime_1'] + result['dressTime_2'] + result['grindTime_2'] + result['dressTime_3'] + result['grindTime_3'] + result['dressTime_4'] + result['grindTime_4']
