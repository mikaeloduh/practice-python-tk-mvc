...
class CycleTimePage(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.result_frame = ttk.Labelframe(self.paned_window, text = " Cycle Time")
    ...
    def getData(self):
        self.data["machining"][0]["passes"] = int(self.grinding_pass_input_1.get())
        self.data["machining"][0]["feedForw"] = float(self.feed_forward_input_1.get())
        self.data["machining"][0]["feedBack"] = float(self.feed_backward_input_1.get())
        self.data["machining"][0]["infeedForw"] = float(self.infeed_forward_input_1.get())
        self.data["machining"][0]["infeedBack"] = float(self.infeed_backward_input_1.get())
        self.data["machining"][0]["pluge"] = float(self.plung_feed_input_1.get())
        self.data["machining"][0]["dressPass"] = int(self.dresssing_pass_input_1.get())
        self.data["machining"][0]["dressInfeed"] = float(self.dresssing_infeed_input_1.get())
        self.data["machining"][0]["dressFeed"] = float(self.dressingFeedInput_1.get())
        self.data["machining"][0]["dressFrq"] =  int(self.dressing_frquency_input_1.get())

        self.data["machining"][1]["passes"] = int(self.grinding_pass_input_2.get())
        self.data["machining"][1]["feedForw"] = float(self.feed_forward_input_2.get())
        self.data["machining"][1]["feedBack"] = float(self.feed_backward_input_2.get())
        self.data["machining"][1]["infeedForw"] = float(self.infeed_forward_input_2.get())
        self.data["machining"][1]["infeedBack"] = float(self.infeed_backward_input_2.get())
        self.data["machining"][1]["pluge"] = float(self.plung_feed_input_2.get())
        self.data["machining"][1]["dressPass"] = int(self.dresssing_pass_input_2.get())
        self.data["machining"][1]["dressInfeed"] = float(self.dresssing_infeed_input_2.get())
        self.data["machining"][1]["dressFeed"] = float(self.dressingFeedInput_2.get())
        self.data["machining"][1]["dressFrq"] =  int(self.dressing_frquency_input_2.get())

        self.data["machining"][2]["passes"] = int(self.grinding_pass_input_3.get())
        self.data["machining"][2]["feedForw"] = float(self.feed_forward_input_3.get())
        self.data["machining"][2]["feedBack"] = float(self.feed_backward_input_3.get())
        self.data["machining"][2]["infeedForw"] = float(self.infeed_forward_input_3.get())
        self.data["machining"][2]["infeedBack"] = float(self.infeed_backward_input_3.get())
        self.data["machining"][2]["pluge"] = float(self.plung_feed_input_3.get())
        self.data["machining"][2]["dressPass"] = int(self.dresssing_pass_input_3.get())
        self.data["machining"][2]["dressInfeed"] = float(self.dresssing_infeed_input_3.get())
        self.data["machining"][2]["dressFeed"] = float(self.dressingFeedInput_3.get())
        self.data["machining"][2]["dressFrq"] =  int(self.dressing_frquency_input_3.get())

        self.data["machining"][3]["passes"] = int(self.grinding_pass_input_4.get())
        self.data["machining"][3]["feedForw"] = float(self.feed_forward_input_4.get())
        self.data["machining"][3]["feedBack"] = float(self.feed_backward_input_4.get())
        self.data["machining"][3]["infeedForw"] = float(self.infeed_forward_input_4.get())
        self.data["machining"][3]["infeedBack"] = float(self.infeed_backward_input_4.get())
        self.data["machining"][3]["pluge"] = float(self.plung_feed_input_4.get())
        self.data["machining"][3]["dressPass"] = int(self.dresssing_pass_input_4.get())
        self.data["machining"][3]["dressInfeed"] = float(self.dresssing_infeed_input_4.get())
        self.data["machining"][3]["dressFeed"] = float(self.dressingFeedInput_4.get())
        self.data["machining"][3]["dressFrq"] =  int(self.dressing_frquency_input_4.get())
    ...
    def setData(self, data):
        ...
        self.grinding_pass_input_1.insert('end', str(self.data["machining"][0]["passes"]))
        self.feed_forward_input_1.delete(0, 'end')
        self.feed_forward_input_1.insert('end', str(self.data["machining"][0]["feedForw"]))
        self.feed_backward_input_1.delete(0, 'end')
        self.feed_backward_input_1.insert('end', str(self.data["machining"][0]["feedBack"]))
        self.infeed_forward_input_1.delete(0, 'end')
        self.infeed_forward_input_1.insert('end', str(self.data["machining"][0]["infeedForw"]))
        self.infeed_backward_input_1.delete(0, 'end')
        self.infeed_backward_input_1.insert('end', str(self.data["machining"][0]["infeedBack"]))
        self.plung_feed_input_1.delete(0, 'end')
        self.plung_feed_input_1.insert('end', str(self.data["machining"][0]["plunge"]))
        self.dresssing_pass_input_1.delete(0, 'end')
        self.dresssing_pass_input_1.insert('end', str(self.data["machining"][0]["dressPass"]))
        self.dresssing_infeed_input_1.delete(0, 'end')
        self.dresssing_infeed_input_1.insert('end', str(self.data["machining"][0]["dressInfeed"]))
        ...
        self.dressing_frquency_input_1.insert('end', str(self.data["machining"][0]["dressFrq"]))

        self.grinding_pass_input_2.delete(0, 'end')
        self.grinding_pass_input_2.insert('end', str(self.data["machining"][1]["passes"]))
        self.feed_forward_input_2.delete(0, 'end')
        self.feed_forward_input_2.insert('end', str(self.data["machining"][1]["feedForw"]))
        self.feed_backward_input_2.delete(0, 'end')
        self.feed_backward_input_2.insert('end', str(self.data["machining"][1]["feedBack"]))
        self.infeed_forward_input_2.delete(0, 'end')
        self.infeed_forward_input_2.insert('end', str(self.data["machining"][1]["infeedForw"]))
        self.infeed_backward_input_2.delete(0, 'end')
        self.infeed_backward_input_2.insert('end', str(self.data["machining"][1]["infeedBack"]))
        self.plung_feed_input_2.delete(0, 'end')
        self.plung_feed_input_2.insert('end', str(self.data["machining"][1]["plunge"]))
        self.dresssing_pass_input_2.delete(0, 'end')
        self.dresssing_pass_input_2.insert('end', str(self.data["machining"][1]["dressPass"]))
        self.dresssing_infeed_input_2.delete(0, 'end')
        self.dresssing_infeed_input_2.insert('end', str(self.data["machining"][1]["dressInfeed"]))
        ...
        self.dressing_frquency_input_2.insert('end', str(self.data["machining"][1]["dressFrq"]))

        self.grinding_pass_input_3.delete(0, 'end')
        self.grinding_pass_input_3.insert('end', str(self.data["machining"][2]["passes"]))
        self.feed_forward_input_3.delete(0, 'end')
        self.feed_forward_input_3.insert('end', str(self.data["machining"][2]["feedForw"]))
        self.feed_backward_input_3.delete(0, 'end')
        self.feed_backward_input_3.insert('end', str(self.data["machining"][2]["feedBack"]))
        self.infeed_forward_input_3.delete(0, 'end')
        self.infeed_forward_input_3.insert('end', str(self.data["machining"][2]["infeedForw"]))
        self.infeed_backward_input_3.delete(0, 'end')
        self.infeed_backward_input_3.insert('end', str(self.data["machining"][2]["infeedBack"]))
        self.plung_feed_input_3.delete(0, 'end')
        self.plung_feed_input_3.insert('end', str(self.data["machining"][2]["plunge"]))
        self.dresssing_pass_input_3.delete(0, 'end')
        self.dresssing_pass_input_3.insert('end', str(self.data["machining"][2]["dressPass"]))
        self.dresssing_infeed_input_3.delete(0, 'end')
        self.dresssing_infeed_input_3.insert('end', str(self.data["machining"][2]["dressInfeed"]))
        ...
        self.dressing_frquency_input_3.insert('end', str(self.data["machining"][2]["dressFrq"]))

        self.grinding_pass_input_4.delete(0, 'end')
        self.grinding_pass_input_4.insert('end', str(self.data["machining"][3]["passes"]))
        self.feed_forward_input_4.delete(0, 'end')
        self.feed_forward_input_4.insert('end', str(self.data["machining"][3]["feedForw"]))
        self.feed_backward_input_4.delete(0, 'end')
        self.feed_backward_input_4.insert('end', str(self.data["machining"][3]["feedBack"]))
        self.infeed_forward_input_4.delete(0, 'end')
        self.infeed_forward_input_4.insert('end', str(self.data["machining"][3]["infeedForw"]))
        self.infeed_backward_input_4.delete(0, 'end')
        self.infeed_backward_input_4.insert('end', str(self.data["machining"][3]["infeedBack"]))
        self.plung_feed_input_4.delete(0, 'end')
        self.plung_feed_input_4.insert('end', str(self.data["machining"][3]["plunge"]))
        self.dresssing_pass_input_4.delete(0, 'end')
        self.dresssing_pass_input_4.insert('end', str(self.data["machining"][3]["dressPass"]))
        self.dresssing_infeed_input_4.delete(0, 'end')
        self.dresssing_infeed_input_4.insert('end', str(self.data["machining"][3]["dressInfeed"]))
        ...
        self.dressing_frquency_input_4.insert('end', str(self.data["machining"][3]["dressFrq"]))
